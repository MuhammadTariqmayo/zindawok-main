                  ...
                  <div class="card-body card-dashboard">
                    ...
                    @foreach($city as $citys)
                        <tr class="gradeX">
                            ...
                            <td class="center">{{$citys->province_id}}</td>
                            <td class="center">{{$citys->name}}</td>
                            <td class="center">{{$citys->created_at}}</td>
                            <td class="center">{{$citys->updated_at}}</td>
                           
                            
                            
                            <td>
                                <a href="{{route('admin_cities_edit',$citys->id)}}">
                                    <small class="label label-primary"><i class="fa"></i>Edit</small>
                                </a>
                                <a href="{{route('admin_cities_destroy',$citys->id)}}">
