                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    @foreach($industry as $indus)
                        <tr class="gradeX">
                            <td>{{$counter}}</td>
                            <td class="center">{{$indus->name}}</td>
                            <td class="center">{{$indus->created_at}}</td>
                            <td class="center">{{$indus->updated_at}}</td>
                            
                            
                            <td>
                                <a href="{{route('admin_industry_edit',$indus->id)}}">
                                    <small class="label label-primary"><i class="fa"></i>Edit</small>
                                </a>
                                <a href="{{route('admin_industry_destroy',$indus->id)}}">
