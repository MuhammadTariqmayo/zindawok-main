...
<div class="row">
  <div class="col-md-12">
                    ...
                    <form class="form form-horizontal" method="POST" action="{{ route('admin_provinces_create') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                          	<div class="col-md-6">
                            	<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                                <input type="text" id="userinput1" class="form-control border-primary" placeholder="Enter province name"
		                                name="name" required>
		                            </div>
                        		</div>
                     		</div>
