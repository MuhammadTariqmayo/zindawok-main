              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    ...
                    @foreach($salary as $salay)
                        <tr class="gradeX">
                            <td>{{$counter}}</td>
                            <td class="center">{{ $salay->start_salary}}</td>
                            <td class="center">{{ $salay->end_salary}}</td>
                            <td class="center">{{ $salay->created_at}}</td>
                            <td class="center">{{ $salay->updated_at}}</td>
                            ...
                            <td>
                                ...
                                @php $prodID= Crypt::encrypt( $salay->id); @endphp
                                <a href="{{route('admin_salary_destroy',$prodID)}}">
