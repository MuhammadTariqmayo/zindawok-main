...
<script>
  $(document).ready(function() {
    ...
    $('#link_table').DataTable({
        ...
        "sAjaxSource": "{{ url('admin/getSubOccupations') }}",
  ...
  function deleteOccupation(id) {
    swal({
        title: "Are you sure？",
        text: "Do you want to delete this Occupation！",
        icon: "warning",
        buttons: {
          cancel: {
    ...
    .then((isConfirm) => {
        if (isConfirm) {
          $.ajax({
            method: "GET",
            url: '/admin/delete_occupation/' + id,
            success: function(result) {
              if(result.status == "success") {
                  $("#row_" + id).hide();
                  swal("Success！", "Sub Occupation has been deleted", "success");
              }
            }
          })
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Sub Occupations</h4>
