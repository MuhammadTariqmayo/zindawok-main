                        ...
                        <h4 class="form-section"><i class="la la-briefcase"></i>Professional & Interpersonal Skills </h4>
                         ...
                         <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="input-selectize" name="professional_skills[]"@if($professional_skills==null)  @else @foreach($professional_skills as $row) value ="{{$row}}"@endforeach @endif required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="input-selectize" name="interpersonal_skills[]"@if($interpersonal_skills==null) @else  @foreach($interpersonal_skills as $row) value ="{{$row}}"@endforeach @endif required>
                                    </div>
                                </div>
                            </div>
                        </div>
