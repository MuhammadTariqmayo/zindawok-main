...
<div class="px-3 px-md-0 mt-5 pt-3">
    ...
    <div class="p-3 mt-3 bg-white container pt-5" style="border-radius: 10px;">
        <form method="POST" action="{{ route('company.profile.setting.update' , $company->id) }}">
        @method('PUT')
        @csrf
          <div class="d-md-flex align-items-center mb-3">
              <label style="flex: 1" class="mb-md-0 mr-sm-4 text-md-right" for="email">Email:</label>
              <input style="flex: 2" name="email" value="{{$company->email}}" type="email" class="form-control mb-0 mr-sm-2" placeholder="Enter email"
                    id="email" readonly>
          </div>
          <div class="d-md-flex align-items-center mb-3">
          ...
          <div class="d-md-flex align-items-center mb-3">
             	...
             	<input style="flex: 2" type="password" name="password_confirmation"  class="form-control mb-md-0 mr-sm-2"
          ...
          <div class="d-md-flex align-items-center mb-3">
             ...
             <div style="flex:2" class="form-control mb-md-0 mr-sm-2">
                <div class="custom-control custom-switch">
                   <input type="checkbox" name="is_active" class="custom-control-input" id="switch1" 
                   @if($company->is_active == 1)checked="" @endif>
                   <label class="custom-control-label font-weight-normal" for="switch1">Deactivate Account</label>
                </div>
             </div>
          </div>
          <div class="mx-auto col-md-4 p-0 mb-3" style="clear:both">
