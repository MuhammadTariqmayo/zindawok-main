...
{{--        </div>--}}
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
               @for($i=0; $i < count($userBookmark); $i++)
                <div class="mt-2">
                        ...
                        <div class="p-3 bg-white border_radius position-relative">
                            <div class="jobListingSection">
                                <div class="d-flex justify-content-between">
                                    <small class="border p-1 text-danger border-danger borderradius4"> <b>{{$userBookmark[$i]->jobs->welcome_bonus}}/RKR- Welcome
                                            bonus</b></small>
                                    <small class="text-muted">3 days ago</small>
                                </div>
                                <div class="d-flex mt-2">
                                    <img src="{{asset('storage/job_image/'.$userBookmark[$i]->jobs->image)}}" class="mr-2 img100" alt="">
                                    <div class="flex_1">
                                        <small>{{$userBookmark[$i]->jobs->company->name}}</small>
                                ...
                                <div class="row" hidden id="error">
                                    <div class="col">
                                        <p class="alert alert-danger" > "you already marked this job" </p>
                                    </div>
                                </div>
                                <div class="row" hidden id="success">
                                    <div class="col">
                                        <p class="alert alert-success" > "job marked successfully!" </p>
                                    </div>
                                </div>
                                <div class="d-flex">
...
{{--                                                <img src={{asset('frontend-assets/img/bookmark.png')}}  class='header_icon_bookmark_buttom ' />--}}
{{--                                            </button>--}}
{{--                                        </form>--}}
{{--                                    @else--}}
...
{{--                                    @endif--}}
            ...
            {{--                --}}{{--            @foreach($cityJobs as $job)--}}
            {{--                --}}{{--                <div class="mt-2">--}}
            {{--                --}}{{--            <a href="JobDetailPage.html" class="text-decoration-none textBlack">--}}
            {{--                --}}{{--              <div class="p-3 bg-white border_radius position-relative">--}}
            {{--                --}}{{--                <div class="jobListingSection">--}}

            {{--                --}}{{--                  <span class="badge CbadgeCustom">{{$job->title}}</span>--}}
