                    ...
                    <div class="col-12 p-0 pb-4">
	                    ...
	                    <div class="wizard">
	                        <nav class="list-group list-group-flush">
	                            <a class="list-group-item d-flex align-items-center" href="EditProfile.html"><i class="fa fa-user text-muted"></i>Profile Edit</a>
	                            ...
	                            <a class="list-group-item d-flex align-items-center" href="U_Settings.html"><i class="fa fa-cog text-muted"></i>Profile Setting</a>
